...
const DiagonalSlider = ({ images, duration = 20, direction = 1, tileDelay = 0 }) => {
...
export default function DiagonalHeroSection() {
  ...
  return (
    <section className="relative w-full rounded-t-2xl bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 mt-10 h-screen mx-auto px-4 px overflow-hidden flex items-center py-16 text-gray-900">
      ...
      >
        <div className="space-y-4">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(255, 123, 0, 0.1) 0%, rgba(234, 88, 12, 0.1) 100%)",
              color: "#ea580c",
          ...
          <h1 className="text-5xl lg:text-6xl font-bold leading-tight tracking-tight">
            <span
              style={{
                background:
                  "linear-gradient(135deg, #ff7b00 0%, #ea580c 50%, #dc2626 100%)",
            ...
            <br />
            <span className="text-gray-800">with Solar Light</span>
            <br />
            <span
              style={{
        ...
        <p className="text-gray-600 max-w-lg text-lg leading-relaxed font-medium">
        ...
        <div className="flex gap-4 pt-4">
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #ff7b00 0%, #ea580c 100%)",
              boxShadow: "0 8px 25px rgba(255, 123, 0, 0.3)",
            }}
          >
          ...
          <button
            className="group px-8 py-4 rounded-2xl font-semibold border-2 transition-all duration-300 hover:scale-105 hover:shadow-lg"
            style={{
              color: "#ff7b00",
              borderColor: "#ff7b00",
            ...
            onMouseEnter={(e) => {
              e.target.style.background = "rgba(255, 123, 0, 0.1)";
              e.target.style.borderColor = "#ea580c";
            }}
            onMouseLeave={(e) => {
              e.target.style.background = "rgba(255, 123, 0, 0.05)";
      ...
      >
        <div className="absolute -right-[100vh] -top-[30vh] w-[200vh] h-[200vh] rotate-[18deg] flex gap-3">
          <DiagonalSlider images={images1} duration={20} direction={1} tileDelay={0.2} />
          <DiagonalSlider images={images2} duration={24} direction={-1} tileDelay={0.5} />
          <DiagonalSlider images={images3} duration={28} direction={1} tileDelay={0.8} />
        </div>
      </motion.div>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, #fef7ed 0%, rgba(254, 247, 237, 0.8) 50%, transparent 100%)",
        }}
      >
        <div className="absolute inset-0 w-full h-full bg-gradient-to-t from-orange-100/80 via-orange-50/40 to-transparent" />
      </div>

      {/* Decorative elements */}
      <div
        className="absolute top-8 right-8 w-20 h-20 rounded-full opacity-10"
        style={{ background: "linear-gradient(135deg, #ff7b00, #ea580c)" }}
      />
      <div
