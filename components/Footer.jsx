...
const Footer = () => {
  ...
  return (
    <motion.footer
      ...
      className="bg-comfort-cream shadow-2xl dark:bg-slate-900 py-5 border-t border-gray-200 dark:border-gray-700  px-4 text-gray-900 dark:text-gray-100 transition-colors duration-300"
    >
