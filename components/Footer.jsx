...
const Footer = () => {
  ...
  return (
    <motion.footer
      ...
      className="bg-comfort-cream dark:bg-slate-900 shadow-2xl border-t border-gray-200 dark:border-gray-700 py-12 px-4 text-gray-900 dark:text-gray-100 transition-colors duration-300"
    >
