...
const AnimatedStatsSection = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      className="w-full bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50  dark:from-sky-light-900 dark:via-sky-light-800 dark:to-sky-light-700 py-20 px-4 relative overflow-hidden transition-colors duration-500"
    >
      ...
      <div className="absolute inset-0 opacity-30 dark:opacity-20">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-br from-amber-200 to-orange-200 dark:from-amber-600/30 dark:to-orange-600/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Join thousands of satisfied customers who've transformed their spaces with our innovative solar lighting solutions
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 dark:group-hover:opacity-30 transition-opacity duration-500 rounded-3xl bg-gradient-to-br ${stat.color} blur-xl`} />
              
              {/* Icon container */}
              <div className={`relative w-16 h-16 ${stat.bgColor} rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300 border border-white/20 dark:border-gray-600/30`}>
                <div className={`text-transparent bg-clip-text bg-gradient-to-r ${stat.color}`}>
                  {stat.icon}
                </div>
                
                {/* Animated ring */}
                <div className="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-current opacity-0 group-hover:opacity-30 dark:group-hover:opacity-50 transition-all duration-500 animate-spin-slow" 
                     style={{ borderImage: `linear-gradient(45deg, transparent, currentColor, transparent) 1` }} />
              </div>
              ...
              <div className="absolute bottom-4 left-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="w-1.5 h-1.5 bg-yellow-400 dark:bg-yellow-300 rounded-full animate-bounce shadow-lg" style={{ animationDelay: '0.5s' }} />
              </div>
            </div>
          ))}
        </div>
