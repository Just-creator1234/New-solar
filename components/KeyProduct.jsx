...
const KeyProduct = () => {
  ...
  const SolarIcon = () => (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <motion.div
          className="w-20 h-20 rounded-full border-2 border-orange-300/30 dark:border-orange-400/40"
          animate={{
        ...
        />
        <motion.div
          className="absolute w-24 h-24 rounded-full border border-orange-200/20 dark:border-orange-300/30"
          animate={{
            scale: isHovered ? 2 : 1,
            opacity: isHovered ? 0 : 1,
          }}
  ...
  return (
    <motion.section
      ref={sectionRef}
      className="w-full bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-24 px-6 md:px-16 relative overflow-hidden text-gray-900 dark:text-white transition-colors duration-500"
      style={{ opacity, scale }}
    >
      {/* Background decoration */}
      <div className="absolute inset-0 opacity-30 dark:opacity-20 pointer-events-none">
        <motion.div
          className="absolute top-10 left-10 w-32 h-32 bg-gradient-to-br from-orange-200 to-yellow-200 dark:from-orange-600/30 dark:to-yellow-600/30 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-10 right-10 w-48 h-48 bg-gradient-to-br from-amber-200 to-orange-200 dark:from-amber-600/30 dark:to-orange-600/30 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.3, 0.6, 0.3],
          }}
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <div className="w-full lg:w-5/12 space-y-8">
            {/* Hero Card */}
            <motion.div
              className="relative bg-gradient-to-br from-orange-500 to-orange-600 dark:from-orange-600 dark:to-orange-700 text-white p-8 rounded-3xl shadow-2xl dark:shadow-slate-900/50 border border-orange-400/20 dark:border-orange-500/30"
            ...
            >
              ...
              <div className="absolute inset-0 overflow-hidden rounded-3xl">
                <motion.div
                  className="absolute -top-10 -right-10 w-40 h-40 bg-white/10 dark:bg-white/5 rounded-full"
                  animate={{
                ...
                />
                <motion.div
                  className="absolute -bottom-10 -left-10 w-32 h-32 bg-yellow-400/20 dark:bg-yellow-400/10 rounded-full"
                  animate={{
                    scale: isHovered ? 1.5 : 1,
                    rotate: isHovered ? -180 : 0,
                  }}
              ...
              <div className="relative z-10 space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <motion.div
                      className="flex items-center gap-2 text-orange-200 dark:text-orange-100"
                ...
                <motion.p
                  className="text-xl leading-relaxed text-orange-50 dark:text-orange-100"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
            ...
            >
              {features.map((feature, index) => (
                <motion.div
                  key={index}
                  className="group bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg dark:shadow-slate-900/30 border border-orange-100 dark:border-slate-700"
                  variants={itemVariants}
                  whileHover={{
                    scale: 1.05,
                    boxShadow: "0 10px 30px rgba(255, 140, 0, 0.15)",
                  }}
                  transition={{ type: "spring", stiffness: 300, damping: 20 }}
                >
                  <div className="flex items-center gap-3 mb-3">
                    <motion.div
                      className="w-10 h-10 bg-gradient-to-br from-orange-500 to-orange-600 dark:from-orange-600 dark:to-orange-700 rounded-xl flex items-center justify-center text-white shadow-lg"
            ...
            >
              <motion.button
                className="group bg-gradient-to-r from-orange-500 to-orange-600 dark:from-orange-600 dark:to-orange-700 text-white px-8 py-4 rounded-2xl font-semibold shadow-lg border border-orange-400/20 dark:border-orange-500/30 flex items-center justify-center gap-2"
                whileHover={{
                  scale: 1.05,
              ...
              <motion.button
                className="group border-2 border-orange-500 dark:border-orange-600 text-orange-600 dark:text-orange-400 px-8 py-4 rounded-2xl font-semibold hover:bg-orange-50 dark:hover:bg-slate-800 flex items-center justify-center gap-2"
                whileHover={{
                  scale: 1.05,
          ...
          <div className="w-full lg:w-7/12">
            ...
            >
              {/* Image container with 3D effect */}
              <motion.div
                className="relative rounded-3xl overflow-hidden shadow-2xl dark:shadow-slate-900/50"
                style={{
                  rotateX,
                  rotateY,
              ...
              >
                ...
                {/* Floating elements */}
                <motion.div
                  className="absolute top-6 right-6 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg"
